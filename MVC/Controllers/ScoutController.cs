...
namespace MVC.Controllers
{
    public class ScoutController : Controller
    {
        ...
        public async Task<ActionResult> Partida(DateTime DtPartida, String ObsScout,
            int jogA1, int golA1,
            int jogA2, int golA2,
            int jogA3, int golA3,
            int jogA4, int golA4,
            ...
            int jogB8, int golB8,
            int jogB9, int golB9,
            int jogB10, int golB10, Scout scout)
        {
            var GolA = golA1 + golA2 + golA3 + golA4 + golA5 + golA6 + golA7 + golA8 + golA9 + golA10;
            var GolB = golB1 + golB2 + golB3 + golB4 + golB5 + golB6 + golB7 + golB8 + golB9 + golB10;
                        
            //Tabela partida = new Tabela()
            //{
            //    scout = scout,
            //    times = equipes
            //};
            #region Jogadores Time A
            List<int> listaJogTimeA = new List<int>();
            scout.JogadorIdA1 = jogA1;
            listaJogTimeA.Add(0);

            scout.JogadorIdA2 = jogA2;
            listaJogTimeA.Add(1);

            scout.JogadorIdA3 = jogA3;
            listaJogTimeA.Add(2);

            scout.JogadorIdA4 = jogA4;
            listaJogTimeA.Add(3);

            scout.JogadorIdA5 = jogA5;
            listaJogTimeA.Add(4);

            scout.JogadorIdA6 = jogA6;
            listaJogTimeA.Add(5);

            scout.JogadorIdA7 = jogA7;
            listaJogTimeA.Add(6);

            scout.JogadorIdA8 = jogA8;
            listaJogTimeA.Add(7);

            scout.JogadorIdA9 = jogA9;
            listaJogTimeA.Add(8);

            scout.JogadorIdA10 = jogA10;
            listaJogTimeA.Add(9);
            #endregion

            #region Gols Time A
            List<int> listaGolTimeA = new List<int>();
            if (golA1.ToString() == null)
            {
                scout.GolsA1 = 0;
                listaGolTimeA.Add(0);
            }
